...
<form method="GET" class="flex gap-3 mb-5">
    ...
    @if(request('buscar') || request('tipo'))
        <a href="{{ route('profesionales.index') }}" class="px-4 py-2 border border-gray-200 rounded-lg text-sm text-[#6B7C93] hover:bg-gray-50 transition">Limpiar</a>
    @endif
</form>
        ...
        <tbody class="divide-y divide-gray-50">
            ...
            <tr class="hover:bg-[#F0F4F8]/50 transition">
                ...
                <td class="px-4 py-3 text-right">
                    <a href="{{ route('profesionales.edit', $prof->id) }}" class="text-[#004494] hover:underline text-xs mr-3">Editar</a>
                    <form method="POST" action="{{ route('profesionales.destroy', $prof->id) }}" class="inline"
